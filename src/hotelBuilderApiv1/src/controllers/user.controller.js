...
const { userService } = require("./user.login");
...
class UserController {
  ...
  async editUser(req, res) {
    try {
      ...
      let updatedUser;
      updatedUser = await user.edit(id, data);
      updatedUser = await user.find({ _id: updatedUser._id });
  ...
  async deleteUser(req, res) {
    try {
      ...
      const existingUser = await user.find({ _id: id}, "-password");
      ...
      // This deletes a user
      const deletedUser = userService.delete(existingUser._id)
